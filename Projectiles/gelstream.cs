		...
		public override void AI()
		{
			...
			if (projectile.ai[0] > 7f)
			{
				...
				if (num298 == 6 || Main.rand.Next(2) == 0)
				{
					...
					{
						int num300 = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, num298, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 100, Color.Blue, 1f);
						Dust dust3;
