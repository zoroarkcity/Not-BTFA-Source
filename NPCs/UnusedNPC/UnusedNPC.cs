...
namespace ForgottenMemories.NPCs.UnusedNPC
{ //this exists purely so I can assign the ancient urn to it as a boss bag, don't delete this
	public class UnusedNPC : ModNPC
	{
		int ai;
