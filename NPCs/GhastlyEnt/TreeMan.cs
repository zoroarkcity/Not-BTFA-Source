...
namespace ForgottenMemories.NPCs.GhastlyEnt
{
	public class TreeMan : ModNPC
	{
		...
		{
			Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/TreeMan/TreeManGore1"), 1f);
			Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/TreeMan/TreeManGore2"), 1f);
			Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/TreeMan/TreeManGore3"), 1f);
			Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/TreeMan/TreeManGore4"), 1f);
